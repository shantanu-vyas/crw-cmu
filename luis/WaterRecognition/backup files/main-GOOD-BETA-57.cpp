...
int main(int argc, char** argv) 
{
    ...
    IplImage* boatFront = cvLoadImage("dam_obstacle.jpg");
    IplImage* backUpImage = cvLoadImage("dam_obstacle.jpg");
    ...
    int x = 100;//(boatFront->height)/2.5 + pixelsNumber + 99; 
    ...
    */
    ...
    while (x < boatFront->height/1.158)
    {
        ...
        // learn classirosrun learning_image_transport my_subscriber _image_transport:=compressed
