...
{
    /***********************************************************************/
    //offline input pictures. Samples are taken from these pictures to get a range
    //of values for H, S, V that will be stored into a pre-defined classifier
    ...
    IplImage* boatFront = cvLoadImage("roundObstacle6.jpg");
