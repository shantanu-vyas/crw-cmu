...
int main(int argc, char** argv) 
{
    ...
    IplImage* boatFront = cvLoadImage("20110805_032301.jpg");
   ...
   // CvMat* trainClasses = cvCreateMat( pixelsNumber, 1, CV_32FC1 );
    ...
    int x = ceil((boatFront->height)/2.5);//(boatFront->height)/2.5 + pixelsNumber + 99; 
    int y = 0; 
    //int ix = 0; 
    //int iy = 0; 
    //int skyX = 0; 
    ...
    */
    ...
    IplImage* imageSample11 = cvLoadImage("20110805_032259.jpg");
    cvSetImageROI(imageSample11, cvRect(0,0,imageSample11->height/0.5,imageSample11->width/1.83));
    ...
    for (int i=0; i < threeArraySize; i++)
    {
        for (int j=0; j < arraySize; j++)
        {
            ...
            I6[row1][column1].h + I7[row1][column1].h + I8[row1][column1].h + I9[row1][column1].h + I10[row1][column1].h + I11[row1][column1].h) / 11;
            averageSat = (I1[row1][column1].s + I2[row1][column1].s + I3[row1][column1].s + I4[row1][column1].s + I5[row1][column1].s + 
            I6[row1][column1].s + I7[row1][column1].s + I8[row1][column1].s + I9[row1][column1].s + I10[row1][column1].s + I11[row1][column1].s) / 11;
            averageVal = (I1[row1][column1].v + I2[row1][column1].v + I3[row1][column1].v + I4[row1][column1].v + I5[row1][column1].v + 
            I6[row1][column1].v + I7[row1][column1].v + I8[row1][column1].v + I9[row1][column1].v + I10[row1][column1].v + I11[row1][column1].v) / 11;
    ...
    //skyX = 0; 
    //skyY = 0;
    while (x < boatFront->height)//(x < boatFront->height/3)
    {
    ...
    /*while (x < boatFront->height/3)
    {
        ...
        if (votesSum > ((boatFront->height/xDivisor)*(boatFront->width/yDivisor)*(8/9)))
        {   
    ...
    /***********  pixel = (513.9332077469)pow(distance,0.240675506  *****************/
            ...
            /*if(obstacleDistance > sqrt(pow(xObstacleDistance,2) + pow(yObstacleDistance,2)))
            {
                ...
                cout << "Obstacle coordinates: " << "X = " << xObstacleDistance << ", Y = " << yObstacleDistance << endl;
