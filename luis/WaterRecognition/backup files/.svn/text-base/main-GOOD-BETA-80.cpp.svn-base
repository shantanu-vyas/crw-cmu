 ...
 * Author: pototo
 *
 * Modified on August 12, 2011, 10:21 AM
 * 
...
int main(int argc, char** argv) 
{
   ...
   for (int i=0; i<boatFront->height;i++)
    ...
    for( CvSeq* c=contours; c!=NULL; c=c->h_next)
    {
        ...
        //cout << "Size of Contour: " << sizeof(c) << endl;                        
        //counter++;
        //find the x,y coordinate of the center of a contour
        cvMoments(c, &moment, 0);
        cout << "Contour center: " << moment.m01/moment.m00 << ", " << moment.m10/moment.m00 << endl;
    }
    
    //print x,y coordinates of the moment
    //cout << "x,y coordinate of" moment->
