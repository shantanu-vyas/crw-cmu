...
//patch is green (this is for me to know where the water patch sample is)
            imageHue[ceil(X/1.286624)+ceil(X/5.237)+i+Mw][ceil(Y/7.07552)+ceil(Y/21.01622)+j+Nw].h = 85/255;
            I[ceil(X/1.286624)+ceil(X/5.237)+i+Mw][ceil(Y/7.07552)+ceil(Y/21.01622)+j+Nw].s = 255/255;
            I[ceil(X/1.286624)+ceil(X/5.237)+i+Mw][ceil(Y/7.07552)+ceil(Y/21.01622)+j+Nw].v = 128/255;
...
//horizon
            groundTrainingHue[i][j] = I[ceil(X/4.7291)+ceil(X/8.3176)+i+Mg][ceil(Y/7.78378)+ceil(Y/16.54468)+j+Ng].h;
            groundTrainingSat[i][j] = I[ceil(X/4.7291)+ceil(X/8.3176)+i+Mg][ceil(Y/7.78378)+ceil(Y/16.54468)+j+Ng].s;
            groundTrainingVal[i][j] = I[ceil(X/4.7291)+ceil(X/8.3176)+i+Mg][ceil(Y/7.78378)+ceil(Y/16.54468)+j+Ng].v;   
//patch is red (this is for me to know where the ground patch sample is)
            I[ceil(X/4.7291)+ceil(X/8.3176)+i+Mg][ceil(Y/7.78378)+ceil(Y/16.54468)+j+Ng].h = 0;
            I[ceil(X/4.7291)+ceil(X/8.3176)+i+Mg][ceil(Y/7.78378)+ceil(Y/16.54468)+j+Ng].s = 1;
            I[ceil(X/4.7291)+ceil(X/8.3176)+i+Mg][ceil(Y/7.78378)+ceil(Y/16.54468)+j+Ng].v = 1;
        }
    }
    ...
    while (x <= X)
    {
        ...
        for (int j1=0; j<itemsNumber;j++)
        {
            ...
            {
                sampleHue[ix][j] = I[x-itemsNumber+ix][j2].h;
                sampleSat[ix][j] = I[x-itemsNumber+ix][j2].s;
                sampleVal[ix][j] = I[x-itemsNumber+ix][j2].v;
            }
        }
