...
int main(int argc, char** argv) 
{
    ...
    //cvGetRows( waterTrainingHue, &trainData1, 0, train_sample_count/2 );
    //cvRandArr( &rng_state, &trainData1, CV_RAND_NORMAL, cvScalar(200,200), cvScalar(50,50) );

    //cvGetRows( waterTrainingHue, &trainData2, train_sample_count/2, train_sample_count );
    //cvRandArr( &rng_state, &trainData2, CV_RAND_NORMAL, cvScalar(300,300), cvScalar(50,50) );

    //cvGetRows( waterTrainingHue, &trainClasses1, 0, train_sample_count/2 );
    ...
    */
    ...
    while (x < X)
    {
        ...
        //{
            ...
            {
                sampleHue->data.fl[ix][0] = I[x-pixelsNumber+ix][j2].h;
                sampleSat->data.fl[ix][0] = I[x-pixelsNumber+ix][j2].s;
                sampleVal->data.fl[ix][0] = I[x-pixelsNumber+ix][j2].v;
