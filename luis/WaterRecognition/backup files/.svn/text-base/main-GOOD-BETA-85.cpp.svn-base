...
int main(int argc, char** argv) 
{
    ...
    IplImage* boatFront = cvLoadImage("20110805_032255.jpg");
    ...
    float yObstacleDistance = 4.5;  //4.5 is distance from water to camera
   ...
   // }
    ...
    for( CvSeq* c=contours; c!=NULL; c=c->h_next)
    {
        ...
        if ((cvContourArea(c, CV_WHOLE_SEQ) >= 50) && (cvContourArea(c, CV_WHOLE_SEQ) <= 100000))
        {
            ...
            zObstacleDistance = (yObstacleDistance*619.33108)/(X - (moment.m01/moment.m00));
            xObstacleDistance = zObstacleDistance*((moment.m10/moment.m00)-324.36738)/618.62586;
            ...
            cout << "Distance (inches) " << obstacleDistance << endl;
