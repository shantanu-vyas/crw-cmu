...
{
    /***********************************************************************/
    IplImage* boatFront = cvLoadImage("bigObstacle3.jpg");
    //IplImage* hsvImage;
    ...
    */
    ...
    //Colors might be wrong because I am using CvMat instead IplImage for my
    //image matrices. Thats another reason why I use BGR2HSV and not RGB2HSV
    ...
    while (x < X)
    {
        ...
        if (ix == pixelsNumber-1)
        {
           ...
           cout << cvmGet(distanceGroundH,0,0);
                ...
                for (int i=0;i<pixelsNumber;i++)
                {
                    for (int j=0;j<pixelsNumber;j++)
                    {
                        ...
                        //if resampleVal(n,n) == 0
                            ...
                            I[x-pixelsNumber+i][y-pixelsNumber+j].v = 190;
                        }
                        votesSum = 0;
                    }
                }
