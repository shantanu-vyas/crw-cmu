...
n = 10;      %number of items for an n x n matrix
...
for i = 1:n
    for j = 1:n
        ...
        waterTraining(i,j,1) = cropped(i+1099-n,j+1099-n,1);
        ...
        cropped(i+1099-n,j+1099-n,1) = 173/255;
        cropped(i+1099-n,j+1099-n,2) = 255/255;
        cropped(i+1099-n,j+1099-n,3) = 47/255;
    end
end
% ground sample
...
for i = 1:n
    for j = 1:n
        % water patch sample (150 X 150 matirx)
        groundTraining(i,j,1) = cropped(i+299-n,j+999-n,1);
        ...
        cropped(i+299-n,j+999-n,1) = 0;
        cropped(i+299-n,j+999-n,2) = 1;
        cropped(i+299-n,j+999-n,3) = 1;
    end
end
...
for i = 1:n          
    for j = 1:n
        ...
        sample(i,j,1) = cropped(i+949,j+1099,1);
...
for i = 1:n
    for j = 1:n
        if groundDistance(i,j) > waterDistance(i,j)
            ...
            cropped(i+949,j+1099,1) = 85/255;
            cropped(i+949,j+1099,2) = 1;
            cropped(i+949,j+1099,3) = 128/255;
        else
            % red otherwise
            cropped(i+949,j+1099,1) = 0;
            cropped(i+949,j+1099,2) = 1;
            cropped(i+949,j+1099,3) = 1;
        end
    end
end
cropped = hsv2rgb(cropped);
