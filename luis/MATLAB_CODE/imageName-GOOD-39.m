...
waterTrainingHue(1:n,1:n) = cropped(round(X/1.2866)+round(X/5.237)+(1:n) + Mw,round(Y/7.0755)+round(Y/21.01622)+(1:n) + Nw,1);
waterTrainingSat(1:n,1:n) = cropped(round(X/1.2866)+round(X/5.237)+(1:n) + Mw,round(Y/7.0755)+round(Y/21.01622)+(1:n) + Nw,2);
waterTrainingVal(1:n,1:n) = cropped(round(X/1.2866)+round(X/5.237)+(1:n) + Mw,round(Y/7.0755)+round(Y/21.01622)+(1:n) + Nw,3);        
%patch is green (this is for me to know where the water patch sample is)
cropped(round(X/1.286624)+round(X/5.237)+(1:n) + Mw,round(Y/7.07552)+round(Y/21.01622)+(1:n) + Nw,1) = 85/255;
cropped(round(X/1.286624)+round(X/5.237)+(1:n) + Mw,round(Y/7.07552)+round(Y/21.01622)+(1:n) + Nw,2) = 255/255;
cropped(round(X/1.286624)+round(X/5.237)+(1:n) + Mw,round(Y/7.07552)+round(Y/21.01622)+(1:n) + Nw,3) = 128/255;
...
% horizon
groundTrainingHue(1:n,1:n) = cropped(round(X/4.7291)+round(X/8.3176)+(1:n) + Mg,round(Y/7.78378)+round(Y/16.54468)+(1:n) + Ng,1);
groundTrainingSat(1:n,1:n) = cropped(round(X/4.7291)+round(X/8.3176)+(1:n) + Mg,round(Y/7.78378)+round(Y/16.54468)+(1:n) + Ng,2);
groundTrainingVal(1:n,1:n) = cropped(round(X/4.7291)+round(X/8.3176)+(1:n) + Mg,round(Y/7.78378)+round(Y/16.54468)+(1:n) + Ng,3);        
%patch is red (this is for me to know where the ground patch sample is)
cropped(round(X/4.7291)+round(X/8.3176)+(1:n) + Mg,round(Y/7.78378)+round(Y/16.54468)+(1:n) + Ng,1) = 0;
cropped(round(X/4.7291)+round(X/8.3176)+(1:n) + Mg,round(Y/7.78378)+round(Y/16.54468)+(1:n) + Ng,2) = 1;
cropped(round(X/4.7291)+round(X/8.3176)+(1:n) + Mg,round(Y/7.78378)+round(Y/16.54468)+(1:n) + Ng,3) = 1;
    ...
    if ((ix == n))
        ...
        for i = 1:n
            for j = 1:n
                ...
                if ((groundDistanceSat(i,j) > waterDistanceSat(i,j)))% && (sampleSat(i,j) <= 0.1))
                    % mark water samples as green
                    comparator(1,2) = 1;
                else
                    comparator(1,2) = 0;
