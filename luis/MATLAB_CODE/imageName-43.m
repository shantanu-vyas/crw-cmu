...
for i = 1:X/2          
    for j = 1:Y/3
        ...
        % value
        if ((I(i,j,3) >= 0.7) && (I(i,j,2) <= 0.1))% && ((I(i,j,2)>=(240/255)) && (I(i,j,2)<=(285/255)))) 
