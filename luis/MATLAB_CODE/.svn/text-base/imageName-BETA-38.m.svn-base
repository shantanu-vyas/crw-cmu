...
groundTrainingHue(1:n,1:n) = cropped(round(X/4.7291)+round(X/8.3176)+(1:n) - 400,round(Y/7.78378)+round(Y/16.54468)+(1:n),1);
groundTrainingSat(1:n,1:n) = cropped(round(X/4.7291)+round(X/8.3176)+(1:n) - 400,round(Y/7.78378)+round(Y/16.54468)+(1:n),2);
groundTrainingVal(1:n,1:n) = cropped(round(X/4.7291)+round(X/8.3176)+(1:n) - 400,round(Y/7.78378)+round(Y/16.54468)+(1:n),3);        
%patch is red (this is for me to know where the ground patch sample is)
cropped(round(X/4.7291)+round(X/8.3176)+(1:n) - 400,round(Y/7.78378)+round(Y/16.54468)+(1:n),1) = 0;
cropped(round(X/4.7291)+round(X/8.3176)+(1:n) - 400,round(Y/7.78378)+round(Y/16.54468)+(1:n),2) = 1;
cropped(round(X/4.7291)+round(X/8.3176)+(1:n) - 400,round(Y/7.78378)+round(Y/16.54468)+(1:n),3) = 1;
    ...
    if ((ix == n))
        ...
        for i = 1:n
            for j = 1:n
                ...
                if ((groundDistanceSat(i,j) > waterDistanceSat(i,j)))
                    % mark water samples as green
                    comparator(1,2) = 1;
                else
                    comparator(1,2) = 0;
                end
                if ((groundDistanceVal(i,j) < waterDistanceVal(i,j)))
                    % mark water samples as green
                    comparator(1,3) = 1;
                else
                    comparator(1,3) = 0;
