...
for i = 1:n
    for j = 1:n
        ...
        waterTraining(i,j) = cropped(i+1099-n,j+1099-n,1);
        ...
        cropped(i+1099-n,j+1099-n,1) = 85/255;
        cropped(i+1099-n,j+1099-n,2) = 255/255;
        cropped(i+1099-n,j+1099-n,3) = 128/255;
    end
end
% ground sample
...
for i = 1:n
    for j = 1:n
        % water patch sample (150 X 150 matirx)
        groundTraining(i,j) = cropped(i+299-n,j+999-n,1);
...
for i = 1:n          
    for j = 1:n
        ...
        sample(i,j) = cropped(i+1020,j+1490,1);
...
for i = 1:n
    for j = 1:n
        if groundDistance(i,j) > waterDistance(i,j)
            ...
            cropped(i+1020,j+1490,1) = 85/255;
            cropped(i+1020,j+1490,2) = 1;
            cropped(i+1020,j+1490,3) = 128/255;
        else
            % red otherwise
            cropped(i+1020,j+1490,1) = 0;
            cropped(i+1020,j+1490,2) = 1;
            cropped(i+1020,j+1490,3) = 1;
        end
    end
end
cropped = hsv2rgb(cropped);
