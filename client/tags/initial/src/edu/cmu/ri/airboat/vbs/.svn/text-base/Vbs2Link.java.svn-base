...
public class Vbs2Link {
    ...
    private final LinkedHashMap<Integer, String> responses = new LinkedHashMap();
    private final ConcurrentLinkedQueue<Integer> ignoreList = new ConcurrentLinkedQueue();
