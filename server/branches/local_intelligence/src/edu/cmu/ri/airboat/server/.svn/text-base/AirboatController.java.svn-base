...
public enum AirboatController {
	...
	ONBOARD_PLANNING(new VehicleController() {

		
		@Override
		public void update(VehicleServer arg0, double arg1) {
			// TODO Auto-generated method stub
			final com.google.code.microlog4android.Logger logger = LoggerFactory.getLogger();
			
			logger.info("Update for ONBOARD_PLANNING");		
			
			//
			// Was working here
			// Can pull out the heart of point and shoot into "blah" and reuse
			// don't want to do things the way it does, because that results in a new server
			//
			//
			//
